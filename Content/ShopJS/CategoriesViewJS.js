$(function () {
    ...
    /*announce and initialization need values*/

    var newCatA = $("a#newcata"); /*class link add*/
    var newCatTextInput = $("#newcatname"); /*class text field input*/
    var ajaxText = $("span.ajax-text"); /*class image download*/
    var table = $("table#pages tbody"); /*class table output*/

    /*write function on catch to put key enter*/
